...
describe('types', () => {
  describe('Basic Maths', () => {
    it('mod returns the remainder of dividing a by b', () => {
      ...
      expect(modulo(10, 2)).to.equal(0)
      expect(modulo(7, 6)).to.equal(1)
    })
  ...
  describe('getLength', () => {
    it('returns the length of the passed string', () => {
      ...
      expect(getLength('hello students')).to.equal(17)
    })
  })
  ...
  describe('capitaliseString', () => {
    it('returns the passed string with the first letter capitalised', () => {
      ...
      expect(capitaliseString('hello students')).to.equal('Hello students')
    })
  })

  describe('dontShoutSentence', () => {
    it('returns the passed sentence in lower case, keeping the first char capitalised', () => {
      expect(dontShoutSentence('HELLO students!!!')).to.equal(
        'Hello students!!!'
      )
    })
  })
  ...
  describe('getLastWord', () => {
    it('returns the last word of the passed sentence', () => {
      ...
      expect(getLastWord('hello students')).to.equal('students')
      expect(getLastWord('hello students, what is going on')).to.equal('on')
    })
  })
  ...
  describe('hyphenateWords', () => {
    it('returns the passed string with spaces replaced by hyphens', () => {
      ...
      expect(hyphenateWords('hello students')).to.equal('hello-students')
  ...
  describe('convertToCamelCase', () => {
    it('returns the passed string convertedToCamelCase', () => {
      ...
      expect(convertToCamelCase('hello students')).to.equal('hellostudents')
  ...
  describe('getStudentsNames', () => {
    it('returns an empty array when given an empty list of students', () => {
      const students = []
      const actual = getStudentsNames(students)
      const expected = []
      expect(actual).to.deep.equal(expected)
    })
    it('returns an array of one name when given a list containing only one northcoder', () => {
      const students = [{ name: 'Mitch', age: 27, language: 'Javascript' }]
      const actual = getStudentsNames(students)
      const expected = ['Mitch']
      expect(actual).to.deep.equal(expected)
    })
    it('returns all the names of all the students', () => {
      const students = [
